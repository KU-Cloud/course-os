...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < NUM_THREADS; i++) {
        ...
        // HINT: The address of variable `i` should be passed when thread
        // created. HINT: Each thread descriptor should be stored appropriately.
    ...
    // HINT: The main thread should not be exited until all `worker`s have
    // finished.
    for (int i = 0; i < NUM_THREADS; i++) {
